...
public class LoginService {
	...
	public String getAccessToken (String authorize_code) {
		...
		try {
			...
			sb.append("&client_id=e70ac5a45fa1cba7935fa44d0c23e6d6"); //본인이 발급받은 Rest Api key
			sb.append("&redirect_uri=http://localhost:8080/baemin/kakaoLogin"); // 본인이 설정한 Redirect Uri 주소
	...
	public HashMap<String, Object> getUserInfo(String access_Token) {
		...
		try {
			...
			// 1. properties와 kakao_account에서 추출한 정보
